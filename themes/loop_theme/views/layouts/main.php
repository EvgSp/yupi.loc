...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="<?php echo Yii::app()->language; ?>"> <!--<![endif]-->
  ...
  ================================================== -->
        ...
        <?php  echo '<!--[if lt IE 9]>
                ...
                echo '<link href="'.$mainAssets .'/css/ie8-and-down.css" type="text/css" rel="stylesheet">'; 
                echo '<![endif]-->';
        ?>
    ...
    <body>
        ...
        <header>
            ...
            <?php } endif; ?>
                                        ...
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/dropKick/jquery.dropkick-1.0.0.js', CClientScript::POS_END);
                                        ?>
                                        <!-- jQuery.nicescroll plug-in -->
                                        <?php
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/jquery.nicescroll.js', CClientScript::POS_END);
                                        ?>
                                        <!-- jQuery.tweet plug-in -->
                                        <?php
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/jquery.tweet.js', CClientScript::POS_END);
                                        ?>
                                        <!-- jQuery.cycle2 plug-in -->
                                        <?php
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/jquery.cycle2.min.js', CClientScript::POS_END);
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/jquery.cycle2.tile.min.js', CClientScript::POS_END);
                                        ?>
                                        <!-- jQuery.jcarousellite plug-in -->
                                        <?php
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/jcarousellite_1.0.1.min.js', CClientScript::POS_END);
                                        ?>
                                        <!-- jQuery.fancybox plug-in -->
                                        <?php
                                        Yii::app()->getClientScript()->registerCssFile($mainAssets . '/js/fancybox/jquery.fancybox-1.3.4.css', CClientScript::POS_END);
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/fancybox/jquery.fancybox-1.3.4.pack.js', CClientScript::POS_END);
                                        ?>
                                        <!-- jQuery.etalage plug-in -->
                                        <?php
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/jquery.etalage.min.js', CClientScript::POS_END);
                                        ?>
                                        ...
                                        <!--my custom code-->	
                                        <?php
                                        Yii::app()->getClientScript()->registerScriptFile($mainAssets . '/js/main.js', CClientScript::POS_END);
                                        ?>
